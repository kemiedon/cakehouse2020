           ...
           <div class="col-md-6" data-animate="fadeInDown">
               <ul class="menu">
                <?php if(isset($_SESSION['member']) && $_SESSION['member'] != null) { ?>
                    <li><a href="customer-account.php"><?php echo $_SESSION['member']['name'];?> 您好!</a>
                   </li>
           ...
           <div class="navbar-header">
               ...
               <div class="navbar-buttons">
                   ...
                   <a class="btn btn-default navbar-toggle" href="basket.php">
                       ...
                       <span class="hidden-xs">(<?php  if(isset($_SESSION['Cart']) && $_SESSION['Cart'] != null) echo count($_SESSION['Cart']); else echo "0"; ?>)</span>
                   </a>
               </div>
           </div>
           <!--/.navbar-header -->

...
if(isset($_POST['EditForm']) && $_POST['EditForm'] == "UPDATE"){
  $sql= "UPDATE members SET  name=:name, birthday=:birthday, gender=:gender, phone=:phone, zipcode=:zipcode, county=:county, district=:district, address=:address, mobile=:mobile, email=:email, updated_at=:updated_at WHERE memberID=:memberID";

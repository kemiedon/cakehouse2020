                                ...
                                <div class="table-responsive">
                                    ...
                                    for($i = 0; $i < count($_SESSION['Cart']); $i++){ ?>
                                        <tr>
                                            ...
                                            <td colspan="2">$NT<?php $subtotal = $_SESSION['Cart'][$i]['price'] * $_SESSION['Cart'][$i]['quantity']; echo $subtotal; ?></td>
                                            </td>
                                        </tr>
                                        <?php       
                                            } 
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th colspan="5">總金額</th>
                                                <th colspan="2">$NT<?php echo $_SESSION['TotalPrice']; ?>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr class="total">
                                        <td>總金額</td>
                                        <th id="totalprice">$NT <?php echo $_SESSION['TotalPrice'] + $_SESSION['shipping']; ?></th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>

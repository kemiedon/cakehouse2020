       ...
       <div class="container">
           ...
           <div class="col-md-6" data-animate="fadeInDown">
               ...
               <?php if(!isset($_SESSION['member']) && $_SESSION['member'] == null) { ?>
                ...
                <?php }else{ ?>
                   <li><a href="#" data-toggle="modal" data-target="#login-modal"><?php echo $_SESSION['member']['name'];?> 您好!</a>
                   </li>
                   <li><a href="logout_success.php">登出</a>
                   </li>
                <?php } ?>
                   <li><a href="web/contact.php">聯絡我們</a>
                   </li>
               </ul>
           </div>
       </div>
           ...
           <div class="modal-dialog modal-sm">
              ...
              <div class="modal-content">
                   ...
                   <div class="modal-body">
                       <form action="function/check_member.php" method="post">
       ...
       <div class="container">
           ...
           <div class="navbar-collapse collapse" id="navigation">
               ...
               <ul class="nav navbar-nav navbar-left">
                   ...
                   <li ><a href="web/about.php">關於我們</a>
                   </li>
                   <li ><a href="web/news_list.php">最新消息</a>
                   </li>
                               ...
                               <div class="yamm-content">
                                   <div class="row">
                                    <?php foreach($product_categories as $category){ ?> 
                                       <div class="col-sm-12">                                  
                                            <a href="web/product_list.php?categoryID=<?php echo $category['product_categoryID']; ?>">
           ...
           <div class="navbar-buttons">
               ...
               <div class="navbar-collapse collapse right" id="basket-overview">
                   <a href="basket.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm">(0)</span></a>
               </div>
               <!--/.nav-collapse -->
